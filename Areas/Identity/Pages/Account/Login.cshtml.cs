...
namespace ManageUsers.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<WebApp1User> signInManager, UserManager<WebApp1User> userManager, ILogger<LoginModel> logger)
        {
